...
def extract_lines(data):
    """
    Extract list of lines from a given server data.
    :param data:
    :return:
    """
    lines = []
...
def read_object(sha1_prefix):
    ...
    (object_type, data_type), or raise ValueError if not found.
    :param sha1_prefix:
    :return:
    """
...
if __name__ == '__main__':
    ...
    sub_parser.add_argument('git_url',
                            help='URL of git repo, eg: https://github.com/USER/REPO.git')
